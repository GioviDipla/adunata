...
// Skip pure cosmetic layouts only. Tokens and double-faced tokens stay in
// because they're gameplay-relevant (creature tokens, treasures, dungeons,
// special cards like The Monarch and the Initiative ride here).
const SKIP_LAYOUTS = new Set(['emblem', 'art_series'])
