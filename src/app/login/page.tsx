...
export const metadata = {
  title: "Adunata — Accedi",
  description:
    "Accedi ad Adunata, la piattaforma gratuita per costruire mazzi di Magic: The Gathering, fare goldfish e giocare partite 1v1.",
};
      ...
      <div className="min-h-screen bg-bg-dark text-font-primary radial-bg" style={{ paddingTop: "env(safe-area-inset-top)" }}>
        <main>
          ...
          <div className="mx-auto max-w-6xl px-4 pb-12 sm:pb-20">
            ...
            <section className="animate-fade-in-up mb-16 sm:mb-24">
              <div className="mx-auto max-w-3xl rounded-2xl border border-border bg-bg-surface p-6 sm:p-10">
                <div className="ornament-left" />
                <h2 className="mb-6 text-center text-xl font-bold tracking-tight sm:text-3xl">
                  Ultimi aggiornamenti
                </h2>
                <div className="space-y-4 text-sm text-font-secondary">
                  <div className="rounded-xl border border-border bg-bg-card p-4">
                    <div className="mb-1 flex items-center gap-2 text-xs text-font-muted">
                      <span className="rounded-full bg-bg-green/15 px-2 py-0.5 text-bg-green">Giugno 2025</span>
                    </div>
                    <p className="leading-relaxed">
                      <strong>GoblinAI</strong> — Assistente IA per le regole di Magic. Menziona le carte con @ e ricevi spiegazioni dettagliate con riferimenti al rulebook ufficiale.
                    </p>
                  </div>
                  <div className="rounded-xl border border-border bg-bg-card p-4">
                    <div className="mb-1 flex items-center gap-2 text-xs text-font-muted">
                      <span className="rounded-full bg-bg-accent/15 px-2 py-0.5 text-bg-accent">Maggio 2025</span>
                    </div>
                    <p className="leading-relaxed">
                      <strong>Multiplayer 1v1</strong> — Partite sincronizzate in tempo reale con chat integrata, gestione fasi e counter condivisi.
                    </p>
                  </div>
                  <div className="rounded-xl border border-border bg-bg-card p-4">
                    <div className="mb-1 flex items-center gap-2 text-xs text-font-muted">
                      <span className="rounded-full bg-bg-yellow/15 px-2 py-0.5 text-bg-yellow">Aprile 2025</span>
                    </div>
                    <p className="leading-relaxed">
                      <strong>Community</strong> — Profili pubblici, mazzi condivisibili, ricerca giocatori. Collezione personale tracciabile con statistiche.
                    </p>
                  </div>
                </div>
              </div>
